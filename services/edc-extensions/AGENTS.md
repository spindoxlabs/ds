...
**Check EDC signatures against the packaged jars, not the source checkout.** The upstream
`eclipse-edc/Connector` source is ahead of the 0.16.0 we build against — it carries
...
[docs/services/edc-extensions.md](../../docs/services/edc-extensions.md).
