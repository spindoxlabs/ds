...
#
# Writes EC P-256 JWK files (private) to services/connector/config/ and
# updates public keys in services/caddy/did/*/did.json.
#
...
for name, did in participants:
    ...
    # Write private key
    priv_path = REPO_ROOT / "services/connector/config" / f"{name}-key.json"
    ...
    did_dir = REPO_ROOT / "services/caddy/did" / host
