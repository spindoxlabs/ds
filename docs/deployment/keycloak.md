...
One derived file matters to an operator:

| File | Generated by | For |
|---|---|---|
| `clients.host.generated.yaml` | `task keycloak:mirror` | **what to merge into a realm you already own** — rendered from `clients.yaml`, the file that crosses |
